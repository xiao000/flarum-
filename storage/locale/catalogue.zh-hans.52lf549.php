...
$catalogueZh = new MessageCatalogue('zh', array (
  'messages' => 
  array (
    'veroz1-users-list.admin.nav.users_button' => '=> veroz1-users-list.ref.users_title',
    'veroz1-users-list.admin.nav.users_text' => '查看会员列表',
    'veroz1-users-list.admin.page.about_text' => '查看注册会员列表',
    'veroz1-users-list.admin.page.online_text' => '=> core.forum.user.online_text',
    'veroz1-users-list.admin.page.load_more_button' => '=> core.ref.load_more',
    'veroz1-users-list.admin.page.list_title' => '=> veroz1-users-list.ref.users_title',
    'veroz1-users-list.admin.page.mail_all_button' => '给所有会员发信',
    'veroz1-users-list.admin.modal_mail.title_text' => '发信给',
    'veroz1-users-list.admin.modal_mail.title_all_text' => '所有会员',
    'veroz1-users-list.admin.modal_mail.email_label' => '收件人',
    'veroz1-users-list.admin.modal_mail.subject_label' => '主题',
    'veroz1-users-list.admin.modal_mail.default_subject' => '=> veroz1-users-list.ref.default_subject',
    'veroz1-users-list.admin.modal_mail.message_label' => '正文',
    'veroz1-users-list.admin.modal_mail.submit_button' => '送出',
    'veroz1-users-list.email.default_subject' => '=> veroz1-users-list.ref.default_subject',
    'veroz1-users-list.ref.default_subject' => '来自论坛管理员的信件',
    'veroz1-users-list.ref.users_title' => '用户们',
  ),
));
...
',
    ...
    'veroz1-users-list.admin.nav.users_button' => '=> veroz1-users-list.ref.users_title',
    'veroz1-users-list.admin.nav.users_text' => 'View users list.',
    'veroz1-users-list.admin.page.about_text' => 'View list of registered users.',
    'veroz1-users-list.admin.page.online_text' => '=> core.forum.user.online_text',
    'veroz1-users-list.admin.page.load_more_button' => '=> core.ref.load_more',
    'veroz1-users-list.admin.page.list_title' => '=> veroz1-users-list.ref.users_title',
    'veroz1-users-list.admin.page.mail_all_button' => 'Mail to all users',
    'veroz1-users-list.admin.modal_mail.title_text' => 'Message for',
    'veroz1-users-list.admin.modal_mail.title_all_text' => 'all users',
    'veroz1-users-list.admin.modal_mail.email_label' => 'To',
    'veroz1-users-list.admin.modal_mail.subject_label' => 'Subject',
    'veroz1-users-list.admin.modal_mail.default_subject' => '=> veroz1-users-list.ref.default_subject',
    'veroz1-users-list.admin.modal_mail.message_label' => 'Message',
    'veroz1-users-list.admin.modal_mail.submit_button' => 'Send',
    'veroz1-users-list.email.default_subject' => '=> veroz1-users-list.ref.default_subject',
    'veroz1-users-list.ref.default_subject' => 'Message from forum administration',
    'veroz1-users-list.ref.users_title' => 'Users',
  ),
));
